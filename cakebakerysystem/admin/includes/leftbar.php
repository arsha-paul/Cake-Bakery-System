...
?>
                ...
                <li>
                    ...
                    <a href="user-detail.php"><i class="fa fa-users"></i> <span class="nav-label">Reg Users</span> <span class="fa arrow"></span></a>
                                   ...
                                   <li>
                    <a href="add_branch.php"><i class="fa fa-users"></i> <span class="nav-label">Add Baker</span> <span class="fa arrow"></span></a>
                                    </li>
 ...
 <li>
        ...
        <li>
                ...
                <li>
                    <a href="#"><i class="fa fa-list"></i> <span class="nav-label"> Custom Orders</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                         <li><a href="notassigned.php">Not Assigned Yet</a></li>
