...
<body>
    ...
    <?php include_once('includes/leftbar.php');?>
     ...
     <p style="text-align: center; color: blue; font-size: 25px">Detail of Order Not Confirmed</p>
              ...
              <?php
              $st=0;
$ret=mysqli_query($con,"select * from tblcustorder where status='$st'");
$cnt=1;
...
function subcat(email,id)
{
  ...
  xmlHttp.send();
                ...
                <td><select class="form-control" onchange="subcat(this.value,<?php echo $row['cid']; ?>);">
                    <option value="">Select</option>
                 <?php   $ret1=mysqli_query($con,"select * from tblbaker");
                 while ($row1=mysqli_fetch_array($ret1)) {
                 ?>
                 <option value="<?php echo $row1['email']; ?>"> <?php echo $row1['bname']; ?></option>
