...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select email from tblbaker where  email='$adminuser' && password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['fosaid']=$ret['email'];
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-8">
            <h2 class="font-bold"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    Cake Bakery System | Baker Login</h2>
