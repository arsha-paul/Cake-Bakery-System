...
<style>
	...
	<?php include_once('includes/header.php');?>
        ...
        <!--================End Main Header Area =================-->
        <section >
       <form><table align="center"style="padding-top: 1px;">
    <th>Choose order type:<th>
<th>
    <select onchange="hai(this.value);">
        
        <option value="1">Orginal</option>
        <option value="2">Custom Made</option>
</select>
...
<script language="javascript" type="text/javascript">
 ...
 $(document).ready(function() {
        ...
        <!--================Cart Table Area =================-->
        <section class="cart_table_area p_100" id="x11">
        	<div class="container">
...
<td><a href="order-detail.php?orderid=<?php echo $row['Ordernumber'];?>" class="btn theme-btn-dash">View Details</a></td>       
        ...
        <!--================Cart Table Area =================-->
        <section class="cart_table_area p_100" style="display:none" id="x2">
        	<div class="container">
				<div class="table-responsive">
                    <h4 style="color: palevioletred;text-align: center;">Your Order Detail</h4>
                    ...
                    $userid= $_SESSION['fosuid'];
 $query=mysqli_query($con,"select * from  tblcustorder  where userid='$userid'");
$cnt=1;
              while($row=mysqli_fetch_array($query))
              { ?>
               <tr>
...
if($st==0){
    ...
    $cid=$row['cid'];
    $ret1=mysqli_query($con,"select * from  tblcdetails where cid ='$cid'");
...
$link .= $_SERVER['HTTP_HOST']; 
?>
 <a href="javascript:void(0);" onClick="popUpWindow('trackorder1.php?oid=<?php echo htmlentities($row['cid']);?>');" title="Track order">Track Order</a></li></td>
<td><a href="order-detail1.php?orderid=<?php echo $row['cid'];?>" class="btn theme-btn-dash">View Details</a></td>       
</tr><?php $cnt=$cnt+1; } ?>
								<td>
